...
def get_hash():
    if os.path.exists('.git'):
        ...
        try:
            from mmsr.version import __version__
...
if __name__ == '__main__':
    ...
    setup(
        name='mmsr',
        version=get_version(),
        description='Open MMLab Image and Video Super-Resolution Toolbox',
        long_description=readme(),
        author='OpenMMLab',
        author_email='xintao.alpha@gmail.com',
        keywords='computer vision, super resolution',
        url='https://github.com/open-mmlab/mmsr',
